...
ordered slice was applied gateway membership generation in #48.
...
exposes both values, reports `MembershipApplied=False`, emits a transition
event, and polls while ConfigMap projection is delayed or observation is stuck;
