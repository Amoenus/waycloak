...
readonly identity="https://github.com/${repository}/.github/workflows/release.yaml@refs/tags/${release_tag}"
readonly signer_workflow="${repository}/.github/workflows/release.yaml"
