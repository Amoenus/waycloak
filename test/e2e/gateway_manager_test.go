...
func TestGatewayManagerAppliesObservedTCPAndUDPDNAT(t *testing.T) {
	...
	desiredWithSecond := desiredWithMembershipGeneration(t, `{"gatewayName":"private","overlayCIDR":"172.30.99.0/24","gatewayAddress":"172.30.99.1","vni":7999,"mtu":1320,"vxlanPort":4789,"tunnelInterface":"tunwaycloak","members":[{"id":"target","overlayAddress":"172.30.99.10","underlayIP":"192.0.2.2"}],"portForwardLeases":[{"identity":"lease-two","internalPort":49153,"protocols":["TCP"],"targetAddress":"172.30.99.10","targetPort":8081},{"identity":"lease-uid","internalPort":49152,"suggestedExternalPort":42001,"protocols":["TCP","UDP"],"targetAddress":"172.30.99.10","targetPort":6881,"leaseGeneration":2}]}`)
