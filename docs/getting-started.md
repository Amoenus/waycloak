# Getting started with Waycloak v0.1.0-rc.1
...
```sh
export WAYCLOAK_TAG=v0.1.0-rc.1
...
`waycloak-0.1.0-rc.1.tgz` and as
`oci://ghcr.io/amoenus/charts/waycloak:0.1.0-rc.1`. Its exact digest is in
...
- [Release-candidate scope and limitations](releases/v0.1.0-rc.1.md)
