...
**Release-candidate checkpoint (2026-08-29):** `v0.1.0-rc.28` preserves the
...
RC.28 delegates provider acquisition and renewal to Gluetun, separates adapter
...
RC.28 remains a release candidate, not
