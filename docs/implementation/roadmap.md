...
**Release-candidate checkpoint (2026-08-29):** `v0.1.0-rc.29` preserves the
...
RC.29 delegates provider acquisition and renewal to Gluetun, separates adapter
...
RC.29 remains a release candidate, not
