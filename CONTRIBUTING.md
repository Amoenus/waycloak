...
Waycloak welcomes design and implementation contributions while it is pre-alpha.
...
Changes should include tests proportional to risk. Networking and admission changes require end-to-end coverage, including a negative or failure-path test. Generated artifacts must be updated in the same change as their source.
